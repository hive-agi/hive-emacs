...
(defun hive-mcp-channel-ws-status ()
  ...
  (interactive)
  (let* ((status (list (cons 'connected (hive-mcp-channel-ws-connected-p)) (cons 'degraded hive-mcp-channel-ws--degraded-mode) (cons 'reconnect-count hive-mcp-channel-ws--reconnect-count) (cons 'queued (length hive-mcp-channel-ws--message-queue)) (cons 'url hive-mcp-channel-ws-url))))
