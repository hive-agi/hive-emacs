...
(defun hive-mcp-addons-addons-auto-load ()
  ...
  (dolist (entry hive-mcp-addon-auto-load-list)
    (let* ((addon (car entry))
        (trigger (cdr entry)))
    (if (featurep trigger) (hive-mcp-addons-addon-load addon) (let* ((addon-sym addon))
    (eval-after-load trigger (list 'hive-mcp-addons-addon-load (list 'quote addon-sym))))))))
...
(defalias 'hive-mcp-addon-register #'hive-mcp-addons-addon-register)
...
(defalias 'hive-mcp-addons-setup #'hive-mcp-addons-addons-setup)

(defalias 'hive-mcp-addons-auto-load #'hive-mcp-addons-addons-auto-load)

(defalias 'hive-mcp-addons--find-file #'hive-mcp-addons---find-file)

(defalias 'hive-mcp-addons--run-init #'hive-mcp-addons---run-init)

(defalias 'hive-mcp-addons--run-async-init #'hive-mcp-addons---run-async-init)

(defalias 'hive-mcp-addons--run-shutdown #'hive-mcp-addons---run-shutdown)

(defalias 'hive-mcp-addons--cleanup #'hive-mcp-addons---cleanup)
