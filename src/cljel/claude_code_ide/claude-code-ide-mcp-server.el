...
(defun claude-code-ide-mcp-server--tool-format-p (tool-spec)
  ...
  (cond
  ((and (consp tool-spec) (symbolp (car tool-spec)) (not (keywordp (car tool-spec)))) 'old)
  ((and (listp tool-spec) (keywordp (car tool-spec))) 'new)
  (t (error "Unknown tool format: %S" tool-spec))))
...
(defun claude-code-ide-mcp-server-get-config (&optional session-id)
  ...
  (when-let ((port (claude-code-ide-mcp-server-get-port)))
    (let* ((path (if session-id (format "/mcp/%s" session-id) "/mcp"))
        ...
        (config (list (cons 'type "http") (cons 'url url))))
    (list (cons 'mcpServers (list (cons 'emacs-tools config)))))))
...
(defun claude-code-ide-mcp-server-get-tool-names (&optional prefix)
  ...
  (mapcar (lambda (tool-spec)
    ...
    (if prefix (concat prefix tool-name) tool-name))) claude-code-ide-mcp-server-tools))
...
(defmacro claude-code-ide-mcp-server-with-session-context (session-id &rest body)
  ...
  (clel-seq (clel-concat (list 'let*) (list (apply clojure-core-vector (clel-seq (clel-concat (list 'clojure.core/context) (list (clel-seq (clel-concat (list 'clojure.core/claude-code-ide-mcp-server-get-session-context) (list session-id)))) (list 'clojure.core/project-dir) (list (clel-seq (clel-concat (list 'clojure.core/plist-get) (list 'clojure.core/context) (list :project-dir)))) (list 'clojure.core/last-active-buffer) (list (clel-seq (clel-concat (list 'clojure.core/plist-get) (list 'clojure.core/context) (list :last-active-buffer)))) (list 'clojure.core/registered-buffer) (list (clel-seq (clel-concat (list 'clojure.core/plist-get) (list 'clojure.core/context) (list :buffer)))) (list 'clojure.core/buffer) (list (clel-seq (clel-concat (list 'clojure.core/or) (list (clel-seq (clel-concat (list 'clojure.core/and) (list 'clojure.core/last-active-buffer) (list (clel-seq (clel-concat (list 'clojure.core/buffer-live-p) (list 'clojure.core/last-active-buffer)))) (list 'clojure.core/last-active-buffer)))) (list (clel-seq (clel-concat (list 'clojure.core/and) (list 'clojure.core/registered-buffer) (list (clel-seq (clel-concat (list 'clojure.core/buffer-live-p) (list 'clojure.core/registered-buffer)))) (list 'clojure.core/registered-buffer))))))))))) (list (clel-seq (clel-concat (list 'if) (list (clel-seq (clel-concat (list 'clojure.core/not) (list 'clojure.core/context)))) (list (clel-seq (clel-concat (list 'clojure.core/error) (list "No session context found for session %s") (list session-id)))) (list (clel-seq (clel-concat (list 'clojure.core/let) (list (apply clojure-core-vector (clel-seq (clel-concat (list 'clojure.core/default-directory) (list (clel-seq (clel-concat (list 'clojure.core/or) (list 'clojure.core/project-dir) (list 'clojure.core/default-directory)))))))) (list (clel-seq (clel-concat (list 'if) (list 'clojure.core/buffer) (list (clel-seq (clel-concat (list 'clojure.core/with-current-buffer) (list 'clojure.core/buffer) body))) body))))))))))))
