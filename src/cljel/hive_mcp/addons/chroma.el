...
(defun hive-mcp-chroma---configure-mcp ()
  ...
  (when (fboundp 'hive-mcp--send-request)
    (hive-mcp--send-request "tools/call" (clel-seq (clel-concat (clojure-core-list :name) (clojure-core-list "cider_eval_silent") (clojure-core-list :arguments) (clojure-core-list (clel-seq (clel-concat (clojure-core-list :code) (clojure-core-list (clel-seq (clel-concat (clojure-core-list 'clojure.core/format) (clojure-core-list "(do\n        (require '[hive-mcp.chroma :as chroma])\n        (chroma/configure! {:host \"%s\" :port %d})\n        %s\n        :configured)") (clojure-core-list 'user/hive-mcp-chroma-host) (clojure-core-list 'user/hive-mcp-chroma-port) (clojure-core-list (clel-seq (clel-concat (clojure-core-list 'user/pcase) (clojure-core-list 'user/hive-mcp-chroma-embedding-provider) (clojure-core-list (clel-seq (clel-concat (clojure-core-list (clel-seq (clel-concat (clojure-core-list 'quote) (clojure-core-list 'user/ollama)))) (clojure-core-list (clel-seq (clel-concat (clojure-core-list 'clojure.core/format) (clojure-core-list "(require '[hive-mcp.embeddings.ollama :as ollama])\n                                                      (chroma/set-embedding-provider!\n                                                        (ollama/->OllamaEmbedder \"%s\"))") (clojure-core-list 'user/hive-mcp-chroma-ollama-model))))))) (clojure-core-list (clel-seq (clel-concat (clojure-core-list (clel-seq (clel-concat (clojure-core-list 'quote) (clojure-core-list 'user/mock)))) (clojure-core-list "(require '[hive-mcp.test-fixtures :as fixtures])\n                                            (chroma/set-embedding-provider!\n                                              (fixtures/->MockEmbedder))")))) (clojure-core-list (clel-seq (clel-concat (clojure-core-list 'user/_) (clojure-core-list ""))))))))))))))) (lambda (response)
...
(defun hive-mcp-chroma---local-search (query limit type)
  ...
  (when (fboundp 'hive-mcp--send-request)
    (hive-mcp--send-request "tools/call" (clel-seq (clel-concat (clojure-core-list :name) (clojure-core-list "mcp_memory_query") (clojure-core-list :arguments) (clojure-core-list (clel-seq (clel-concat (clojure-core-list :type) (clojure-core-list (clel-seq (clel-concat (clojure-core-list 'clojure.core/or) (clojure-core-list 'clojure.core/type) (clojure-core-list "note")))) (clojure-core-list :limit) (clojure-core-list (clel-seq (clel-concat (clojure-core-list 'clojure.core/or) (clojure-core-list 'user/limit) (clojure-core-list 20))))))))) (lambda (response)
...
(defun hive-mcp-chroma---display-results (results source)
  ...
  (let* ((buf (get-buffer-create "*MCP Memory Search*")))
    ...
    (insert (format "  %s\n\n" (if (> (length doc) 200) (clel-concat (substring doc 0 200) "...") doc))))))
    (goto-char (point-min))))
    (display-buffer buf)))
...
(defun hive-mcp-chroma-index-all ()
  ...
  (when (fboundp 'hive-mcp--send-request)
    ...
    (hive-mcp--send-request "tools/call" (clel-seq (clel-concat (clojure-core-list :name) (clojure-core-list "cider_eval_silent") (clojure-core-list :arguments) (clojure-core-list (clel-seq (clel-concat (clojure-core-list :code) (clojure-core-list "(do\n        (require '[hive-mcp.chroma :as chroma])\n        (require '[hive-mcp.memory :as memory])\n        (let [entries (memory/get-all-entries)]\n          (chroma/index-memory-entries! entries)\n          (count entries)))")))))) (lambda (response)
