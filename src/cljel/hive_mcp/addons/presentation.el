...
(defun hive-mcp-presentation-preview ()
  ...
  ((quote beamer) (let* ((pdf-file (clel-concat (file-name-sans-extension buffer-file-name) ".pdf")))
    ...
    (find-file-other-window (clel-concat (file-name-sans-extension buffer-file-name) ".pdf"))))))
  ((quote revealjs) (let* ((html-file (clel-concat (file-name-sans-extension buffer-file-name) ".html")))
...
(defun hive-mcp-presentation-refresh ()
  ...
  (let* ((html-file (clel-concat (file-name-sans-extension buffer-file-name) ".html")))
    (browse-url-of-file html-file)
...
(defun hive-mcp-presentation-open-html-in-browser (file)
  ...
  (interactive "fFile: ")
  (let* ((html-file (if (string-suffix-p ".html" file) file (clel-concat (file-name-sans-extension file) ".html"))))
