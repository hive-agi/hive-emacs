...
(defun hive-mcp-triggers-show-conversation-history ()
  ...
  (let* ((buf (get-buffer-create "*hive-mcp-conversations*"))
    ...
    (dolist (entry (clel-reverse history))
...
(defalias 'hive-mcp-setup-keybindings #'hive-mcp-triggers-setup-keybindings)

(defalias 'hive-mcp-setup-hooks #'hive-mcp-triggers-setup-hooks)

(defalias 'hive-mcp-add-note-interactive #'hive-mcp-triggers-add-note-interactive)

(defalias 'hive-mcp-add-snippet-interactive #'hive-mcp-triggers-add-snippet-interactive)

(defalias 'hive-mcp-show-context #'hive-mcp-triggers-show-context)

(defalias 'hive-mcp-show-memory #'hive-mcp-triggers-show-memory)
