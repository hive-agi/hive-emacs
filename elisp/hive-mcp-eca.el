...
(with-eval-after-load 'hive-mcp-addons
  (hive-mcp-addon-register 'eca :version "0.1.0" :description "ECA integration" :requires '(hive-mcp-api) :provides '(hive-mcp-eca-mode) :init #'hive-mcp-eca--addon-init :shutdown #'hive-mcp-eca--addon-shutdown))
