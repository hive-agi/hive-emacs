...
(defun hive-mcp-log-log (&rest clel--args)
  ...
  (when (and (hive-mcp-log--level-enabled-p level) (hive-mcp-log--component-enabled-p component))
    (let* ((message (clel-apply #'format format-string args)))
