...
(defun hive-mcp-cider-memory-eval-request-advice (orig-fun input callback &rest args)
  ...
  (clel-apply orig-fun input (if hive-mcp-cider-memory-auto-log (hive-mcp-cider-memory-make-capture-callback input (hive-mcp-cider-memory--current-ns) callback) callback) args))
