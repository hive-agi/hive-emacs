...
(with-eval-after-load 'hive-mcp-addons
  (hive-mcp-addon-register 'addon-template :version "0.1.0" :description "Template addon for hive-mcp" :requires '(hive-mcp-api) :provides '(hive-mcp-template-mode) :init #'hive-mcp-template--addon-init :async-init #'hive-mcp-template--addon-async-init :shutdown #'hive-mcp-template--addon-shutdown))
