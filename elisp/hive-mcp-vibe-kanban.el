...
(defun hive-mcp-vibe-kanban--start-async ()
  ...
  (unless (hive-mcp-vibe-kanban--running-p)
    ...
    (setq hive-mcp-vibe-kanban--process (clel-apply #'start-process "vibe-kanban" buf hive-mcp-vibe-kanban-command hive-mcp-vibe-kanban-args))
...
(with-eval-after-load 'hive-mcp-addons
  (hive-mcp-addon-register 'vibe-kanban :version "0.1.0" :description "Vibe Kanban task management server" :requires '(hive-mcp-api) :provides '(hive-mcp-vibe-kanban-transient) :init #'hive-mcp-vibe-kanban--addon-init :async-init #'hive-mcp-vibe-kanban--addon-async-init :shutdown #'hive-mcp-vibe-kanban--addon-shutdown))
